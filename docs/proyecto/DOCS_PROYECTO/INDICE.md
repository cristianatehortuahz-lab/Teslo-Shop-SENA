...
Esta carpeta contiene toda la documentación creada durante el desarrollo del proyecto Nova Shop para SENA.
...
Esta carpeta contiene **toda la documentación profesional** del proyecto Nova Shop:
...
**Proyecto:** Nova Shop E-Commerce Full-Stack  
